...
from app_onnx.model import encode_single, encode_batch, MODEL_NAME, EMBEDDING_DIM, model_load_time
...
app = FastAPI(title="rubert-mini-frida ONNX Inference Service")
